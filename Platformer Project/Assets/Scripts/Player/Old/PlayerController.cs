...
public class PlayerController : MonoBehaviour
{
    ...
    private void CheckSurroundings()
    {
        ...
        isTouchingLadge = Physics2D.Raycast(ledgeCheck.position, transform.right, wallCheckDistance, whatIsGround);
        
        if(isTouchingWall && !isTouchingLadge && !ledgeDetection)
        {
            ledgeDetection = true;
