...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        RaycastHit2D yHit = Physics2D.Raycast(core.CollisionSenses.LedgeCheckHorisontal.position + (Vector3)(workspace), Vector2.down, core.CollisionSenses.LedgeCheckHorisontal.position.y - core.CollisionSenses.WallCheck.position.y + 0.015f, core.CollisionSenses.WhatIsGround);
        float yDist = yHit.distance;

        workspace.Set(core.CollisionSenses.WallCheck.position.x + (xDist * core.Movement.FacingDirection), core.CollisionSenses.LedgeCheckHorisontal.position.y - yDist);
        return workspace;
    }
}
